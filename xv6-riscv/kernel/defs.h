...
void            wakeup(void*);
void            yield(void);
// mlfq_tick() is called from trap.c on every timer interrupt, for the process that is running.
// It charges one tick to that process and decides whether it has to give up the CPU. It only
